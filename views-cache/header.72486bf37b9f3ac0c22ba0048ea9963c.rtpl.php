...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="active"><a href="/acoes?limit="><i class="fa fa-envelope"></i> <span>Ações</span></a></li>
      <li><a href="/notas?pg=1&limit=10"><i class="fa fa-envelope"></i> <span>Notas Compra</span></a></li>
      <li><a href="/acoes-estoque"><i class="fa fa-envelope"></i> <span>Estoque</span></a></li>
      <li class="treeview">
