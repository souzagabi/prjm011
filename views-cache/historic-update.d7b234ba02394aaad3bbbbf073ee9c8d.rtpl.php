...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/historic/<?php echo htmlspecialchars( $historic["fireexting_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Histórico</a></li>
        <li class="active"><a href="/historicU/<?php echo htmlspecialchars( $historic["historic_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Edição</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-md-12">
            ...
            <form role="form" action="/historic/<?php echo htmlspecialchars( $historic["historic_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-footer">
               ...
               <a href="/historic?fireexting_id=<?php echo htmlspecialchars( $historic["fireexting_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>&limit=10" class="btn btn-warning">Voltar</a>
              </div>
            </form>
          </div>
          </div>
