                    ...
                    <tr>
                      ...
                      <td class="body-padded">
                        ...
                        <table class="body-text">
                          ...
                          <tr>
                            <th class="body-text-cell" 
                                style="background-color:#f8ebd5;
                                color: #7e5117;
                                font-size: 16px;
                                font-weight: bold;
                                padding: 25px;
                                border-radius: 10px;">
                              Você tem 5 minutos para redefinir a senha.
                            </th>
                          </tr>
                        </table>
                        <div><!--[if mso]>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Obrigado!</p>
                              <p class="body-signature"><img src="https://www.filepicker.io/api/file/2R9HpqboTPaB4NyF35xt" alt="Nome da Empresa"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
