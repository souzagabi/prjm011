...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/fireextingH">Extintores</a></li>
        <li class="active"><a href="/fireextingH/create">Cadastrar</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-md-12">
            ...
            <form role="form" action="/fireextingH/create" method="post" enctype="multipart/form-data">
              <input type="text" name="fireexting_id" value="<?php echo htmlspecialchars( $fireexting_id, ENT_COMPAT, 'UTF-8', FALSE ); ?>" hidden>
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <a href="/fireextingH/<?php echo htmlspecialchars( $fireexting_id, ENT_COMPAT, 'UTF-8', FALSE ); ?>?limit=10" class="btn btn-warning">Voltar</a>
