              ...
              <div class="box-body">
                <div class="col col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="location" id="location" value="<?php echo htmlspecialchars( $airconditioning["location"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onKeyUp="convertLowToUpper(location)" autofocus="autofocus" required>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
