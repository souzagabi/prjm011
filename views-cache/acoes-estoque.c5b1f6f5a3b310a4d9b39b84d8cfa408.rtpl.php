        ...
        <div class="col col-md-12">
          <nav aria-label="Page navigation">
            <ul class="pagination">
              ...
              <li><a href="acoes-estoque?pg=<?php echo htmlspecialchars( $i, ENT_COMPAT, 'UTF-8', FALSE ); ?><?php if( $pgs["list"]["listestoque"]  ){ ?>&listestoque =<?php echo htmlspecialchars( $pgs["list"]["listestoque"] , ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?><?php if( $pgs["list"]["dtbuy"] ){ ?>&dtbuy=<?php echo htmlspecialchars( $pgs["list"]["dtbuy"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?><?php if( $pgs["list"]["dtsell"] ){ ?>&dtsell=<?php echo htmlspecialchars( $pgs["list"]["dtsell"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?><?php if( $pgs["list"]["search"] ){ ?>&search=<?php echo htmlspecialchars( $pgs["list"]["search"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>"><?php echo htmlspecialchars( $i++, ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
              <?php } ?>
              <li>
