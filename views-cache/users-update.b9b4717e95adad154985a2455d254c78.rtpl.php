            ...
            <div class="box-body">  
              ...
              <div class="col col-md-3">
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" id="confirmasenha" onChange="verifyConfPassWord(senha,confirmasenha,msgDanger)" placeholder="Digite a senha novamente">
                </div>
              </div>
              <div class="col col-md-2">
                <div class="checkbox">
